...
class Emoticon {
  ...
  public PImage getExpImg() {
    return expImg;
  }
  
  public PVector getManiPivotPos() {
    return maniPivotPos;
  }
  
  public PVector getTransPivotPos() {
    return transPivotPos;
  }
  
  public void setManiPivotPos(PVector maniPivotPos) {
    this.maniPivotPos = maniPivotPos;
  }
  
  public void setTransPivotPos(PVector transPivotPos) {
    this.transPivotPos = transPivotPos;
  }
  
  public boolean[] getIsMani() {
    return isMani;
  }
  
  public boolean getIsMani(int i) {
    return isMani[i];
  }
  
  public void setIsMani(boolean[] isMani) {
    this.isMani = isMani;
  }
  
  public void setIsMani(int i, boolean isMani) {
  ...
  public ArrayList<PVector> getEndPivotPos() {
    return endPivotPos;
  }
}
